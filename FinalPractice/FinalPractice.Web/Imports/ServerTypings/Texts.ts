    ...
    declare namespace Db {
        ...
        namespace SportDB {
            ...
            namespace Customer {
                ...
                export const FullUsername: string;
            ...
            namespace Order {
                ...
                export const CutormerFirstname: string;
                export const CutormerGender: string;
                export const CutormerId: string;
                export const CutormerLastname: string;
            ...
            namespace OrderDetails {
                ...
                export const OrderCutormerId: string;
                export const OrderDetailsId: string;
                export const OrderId: string;
                export const OrderReleaseDate: string;
